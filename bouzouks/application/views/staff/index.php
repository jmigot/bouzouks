		...
		<div class="demi_cellule_bleu_type1 inline-block">
			...
			<div class="bloc_bleu">
				...
				<ul>
					...
					<?= $this->lib_staff->lien_admin('Gérer les maps',     'gerer_maps') ?>
					<?= $this->lib_staff->lien_admin('Gérer les serveurs', 'gerer_serveurs') ?>
					<?= $this->lib_staff->lien_admin('Gérer le site',      'gerer_site') ?>
					<?= $this->lib_staff->lien_admin('Gérer le jeu',     'gerer_jeu') ?>
				</ul>
			</div>
		</div>
	<?php endif; ?>
