...
$smilies = array(
	':)'            => array('smile.png',     15, 15, 1),
	':|'            => array('neutral.png',   15, 15, 1),
	':('            => array('sad.png',       15, 15, 1),
	':D'            => array('big_smile.png', 15, 15, 1),
	':o'            => array('yikes.png',     15, 15, 1),
	';)'            => array('wink.png',      15, 15, 1),
	':/'            => array('hmm.png',       15, 15, 1),
	':P'            => array('tongue.png',    15, 15, 1),
	':lol:'         => array('lol.png',       15, 15, 1),
	':mad:'         => array('mad.png',       15, 15, 1),
	':rolleyes:'    => array('roll.png',      15, 15, 1),
	':cool:'        => array('cool.png',      15, 15, 1),
	
	':argh:'        => array('argh.gif',    20, 20, 0),
	':classe:'      => array('classe.gif',  20, 20, 0),
	':grrr:'        => array('grrr.gif',    20, 20, 0),
	':happy:'       => array('happy.gif',   20, 20, 0),
	':hey:'         => array('hey.gif',     20, 20, 0),
	':hu:'          => array('hu.gif',      20, 20, 0),
	':lol2:'        => array('lol.gif',     20, 20, 0),
	':oui:'         => array('oui.gif',     17, 22, 0),
	':pfff:'        => array('pfff.gif',    20, 20, 0),
	':rhaaa:'       => array('rhaaa.gif',   20, 20, 0),
	':search:'      => array('search.gif',  20, 20, 0),
	':smile:'       => array('smile.gif',   20, 20, 0),
	':-('           => array('triste.gif',  20, 20, 0),
	':zzz:'         => array('zzz.gif',     20, 20, 0),
	':baille:'      => array('baille.gif',  20, 20, 0),
	';-)'           => array('cling.gif',   20, 20, 0),
	':haha:'        => array('haha.gif',    20, 20, 0),
	':heu:'         => array('heuuuu.gif',  20, 20, 0),
	':love:'        => array('love.gif',    20, 20, 0),
	':oeil:'        => array('oeil.gif',    20, 20, 0),
	':ouin:'        => array('ouin.gif',    20, 20, 0),
	':respect:'     => array('respect.gif', 20, 20, 0),
	':saoul:'       => array('saoul.gif',   20, 20, 0),
	':-p'           => array('tongue.gif',  20, 20, 0),
	':ups:'         => array('ups.gif',     20, 20, 0),
	':non:'         => array('non.gif',     23, 20, 0),
	':hinhin:'      => array('hinhin.gif',  20, 20, 0),

	':saint:'       => array('secrets/ange.gif',                25, 25, 2),
	':choque:'      => array('secrets/chut.gif',                20, 25, 2),
	':hurle_red:'   => array('secrets/hurle1.gif',              35, 29, 2),
	':hurle_blue:'  => array('secrets/hurle2.gif',              35, 29, 2),
	':bierro:'      => array('secrets/biere.gif',               8,  21, 2),
	':pioupiouk:'   => array('secrets/piouk.gif',               24, 16, 2),
	':shit:'        => array('secrets/crocomouth.gif',          26, 27, 2),
	':bisou:'       => array('secrets/kiss.gif',                35, 20, 2),
	':idiot:'       => array('secrets/normal.gif',              20, 20, 2),
	':svp:'         => array('secrets/ouinon.gif',              25, 20, 2),
	':rock:'        => array('secrets/rock.gif',                32, 27, 2),
	':squelete:'    => array('secrets/squeleton.gif',           20, 20, 2),
	':java:'        => array('secrets/tasse.gif',               19, 19, 2),
	':cafe:'        => array('secrets/cafe.gif',                15, 15, 2),
	':surprise:'    => array('secrets/cadouille.gif',           30, 34, 2),
	':schnibble:'   => array('secrets/schnibble.gif',           25, 34, 2),
	':ninja:'       => array('secrets/kamikaz.gif',             20, 20, 2),
	':pincemi:'     => array('secrets/lovefool.gif',            20, 20, 2),
	':noel:'        => array('secrets/nozouk.gif',              20, 20, 2),
	':zombie:'      => array('secrets/zombee.gif',              20, 20, 2),
	':fete:'        => array('secrets/pouet.gif',               21, 20, 2),
	':diablotin:'   => array('secrets/satan.gif',               20, 20, 2),
	':starwars:'    => array('secrets/starfighter.gif',     20, 20, 2),
	':danse:'       => array('secrets/bouzoukette.gif',         20, 24, 2),
	':exclaim:'     => array('secrets/exclamation.gif',         17, 20, 2),
	':contrat:'     => array('secrets/contrat.gif',		        21, 24, 2),
	':raki:'	    => array('secrets/raki.gif',		        19, 20, 2),
	':greve:'	    => array('secrets/greve.gif',		        85, 30, 2),
	':link:'	    => array('secrets/link.gif',		        26, 21, 2),
	':yeah:'        => array('secrets/yeah.gif',                29, 24, 2) // no comma after last item
);


// Ajouté pour bouzouks
function bbcode($smilies_cache = 0)
{
	global $smilies;
	
	$retour = '<p>';
	$retour .= '<input type="button" value="Gras" class="bbcode_gras"><span id="bbcode_gras" class="bouzouk_invisible">[b]|[/b]</span>';
	$retour .= '<input type="button" value="Italique" class="bbcode_italique"><span id="bbcode_italique" class="bouzouk_invisible">[i]|[/i]</span>';
	$retour .= '<input type="button" value="Souligné" class="bbcode_souligne"><span id="bbcode_souligne" class="bouzouk_invisible">[u]|[/u]</span>&nbsp;&nbsp;|&nbsp;&nbsp;';

	$retour .= '<select class="bbcode_couleur">';
	$retour .= '<option value="red">Rouge</option>';
	$retour .= '<option value="blue">Bleu</option>';
	$retour .= '<option value="green">Vert</option>';
	$retour .= '<option value="orange">Orange</option>';
	$retour .= '<option value="gray">Gris</option>';
	$retour .= '<option value="purple">Pourpre</option>';
	$retour .= '</select>';
	$retour .= '<input type="button" value="Couleur" class="bbcode_couleur">&nbsp;&nbsp;|&nbsp;&nbsp;';

	$retour .= '<input type="button" value="Centré" class="bbcode_centrer"><span id="bbcode_centrer" class="bouzouk_invisible">[center]|[/center]</span>';
	$retour .= '<input type="button" value="Justifié" class="bbcode_justifier"><span id="bbcode_justifier" class="bouzouk_invisible">[justify]|[/justify]</span>';
	$retour .= '<input type="button" value="Citation" class="bbcode_citation"><span id="bbcode_citation" class="bouzouk_invisible">[quote]|[/quote]</span>&nbsp;&nbsp;|&nbsp;&nbsp;';

	$retour .= '<input type="button" value="Image" class="bbcode_image">';
	$retour .= '<input type="button" value="Lien" class="bbcode_lien">&nbsp;&nbsp;|&nbsp;&nbsp;';

	foreach ($smilies as $smiley => $img_url)
		if ($img_url[3] <= $smilies_cache)
			$retour .= '<img src="'.pun_htmlspecialchars(get_base_url(true)).'/img/smilies/'.$img_url[0].'" width="'.$img_url[1].'" height="'.$img_url[2].'" alt="'.$smiley.'" class="bbcode_smiley">&nbsp;';
...
function preparse_tags($text, &$errors, $is_signature = false)
{
	...
	$tags = array('quote', 'code', 'b', 'i', 'u', 's', 'ins', 'del', 'em', 'color', 'colour', 'url', 'email', 'img', 'list', '*', 'h', 'topic', 'post', 'forum', 'user', 'center', 'justify');
	...
	$tags_block = array('quote', 'code', 'list', 'h', '*', 'center');
	...
	$tags_limit_bbcode = array(
		...
		'user'    => array('img'),
		'img' 	  => array(),
		'center'  => array('b', 'i', 'u', 's', 'ins', 'del', 'em', 'color', 'colour', 'url', 'email', 'img', 'topic', 'post', 'forum', 'user', 'h'),
		'justify' => array('b', 'i', 'u', 's', 'ins', 'del', 'em', 'color', 'colour', 'url', 'email', 'img', 'topic', 'post', 'forum', 'user', 'h'),
...
function do_smilies($text)
{
	...
	foreach ($smilies as $smiley_text => $smiley_img)
	{
		if (strpos($text, $smiley_text) !== false)
			$text = ucp_preg_replace('%(?<=[>\s])'.preg_quote($smiley_text, '%').'(?=[^\p{L}\p{N}])%um', '<img src="'.pun_htmlspecialchars(get_base_url(true).'/img/smilies/'.$smiley_img[0]).'" width="'.$smiley_img[1].'" height="'.$smiley_img[2].'" alt="'.substr($smiley_img[0], 0, strrpos($smiley_img[0], '.')).'" />', $text);
	}
