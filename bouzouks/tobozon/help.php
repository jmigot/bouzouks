...
<div class="box">
	<div class="inbox">
		...
		<p><code>[center]<?php echo $lang_help['Centered text'] ?>[/center]</code> <?php echo $lang_help['produces'] ?> <samp><?php echo $lang_help['Centered text'] ?></samp></p>
		<p><code>[justify]<?php echo $lang_help['Justified text'] ?>[/justify]</code> <?php echo $lang_help['produces'] ?> <samp><?php echo $lang_help['Justified text'] ?></samp></p>
...
foreach ($smilies as $smiley_text => $smiley_img)
	if ($smiley_img[3] == 0)
		$smiley_groups[$smiley_img[0]][] = $smiley_text;
